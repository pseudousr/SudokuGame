...
public class LineIndicator : MonoBehaviour
{
    ...
    private (int, int) GetSquarePoition(int square_index)
    {
        int pos_row = -1;
        int pos_col = -1;
    ...
    public int[] GetHorizontalLine(int square_index)
    {
        ...
        var sqaure_position_row = GetSquarePoition(square_index).Item1;

        for(int index = 0; index <9; index++)
        {
            line[index] = line_data[sqaure_position_row, index];
        }
    ...
    public int[] GetVerticalLine(int square_index)
    {
        ...
        var sqaure_position_col = GetSquarePoition(square_index).Item2;

        for(int index = 0; index < 9; index++)
        {
            line[index] = line_data[index, sqaure_position_col];
        }
        return line;
    }
